...
const Conversations: React.FC = () => {
    ...
    useEffect(() => {
        ...
        const fetchParts = async () => {
            try {
                const response = await axiosInstance.get(`/api/part/allparts/conversations`);
    ...
    return (
        <Container maxWidth="lg">
            ...
            Select the best answer of the four choices for each question. You will get 40 minutes to complete this part. Your score will be given at the end.
            </Typography>
