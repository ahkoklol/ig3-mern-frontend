...
const QuestionResponse: React.FC = () => {
    ...
    useEffect(() => {
        ...
        const fetchParts = async () => {
            try {
                const response = await axiosInstance.get(`/api/part/allparts/Question-Response`);
    ...
    return (
        <Container maxWidth="lg">
            ...
            Select the best answer of the three choices that best fits the situation. You will get 30 minutes to complete this part. Your score will be given at the end.
            </Typography>
