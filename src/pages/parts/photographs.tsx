...
const Photographs: React.FC = () => {
    ...
    useEffect(() => {
        ...
        const fetchParts = async () => {
            try {
                const response = await axiosInstance.get(`/api/part/allparts/photographs`);
    ...
    return (
        <Container maxWidth="lg">
            ...
            Select the best answer that describes the image. You will get 5 minutes to complete this part. Your score will be given at the end.
            </Typography>
