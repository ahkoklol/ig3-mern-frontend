...
const CreatePart: React.FC = () => {
    ...
    return (
        <Container maxWidth="lg" sx={{marginTop: '20px', marginBottom: '30px'}}>
            ...
            <Typography variant="body2" gutterBottom sx={{ color: 'black', textAlign: 'justify', marginBottom: '20px' }}>This section is available only to teachers. Please fill in all fields. If an part ref already exists, do not try to put the same number. If you have common sense, do not put random part refs, try naming them to not get confused by numbers because there will be a lot of parts. The time is in second: be careful and convert the hours to seconds. Friendly reminder that 1 hours = 3600 seconds. You just have to enter 3600, it's pretty straightforward, but I had to explain just in case. Oh, and yes, if you create a part, all of the questions that were created belonging to that part ref will be used to generate this part!</Typography>
